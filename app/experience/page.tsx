  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 md:px-0">
        <div className="space-y-12 w-full max-w-6xl">
            ...
            <div>
              <h1 className='text-3xl md:text-4xl font-bold text-left ml-9 md:ml-28 mt-30 md:mt-30'>Recent Experience</h1>
              
              <div className="grid grid-cols-1 gap-6 mt-6 md:grid-cols-2 md:grid-flow-row md:gap-x-5 md:min-w-100">
